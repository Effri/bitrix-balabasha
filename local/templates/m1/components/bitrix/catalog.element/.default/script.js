	...
	window.JCCatalogElement.prototype = {
		...
		init: function()
		{
			...
			if (this.config.showPrice)
			{
				...
				if (this.obBasketActions)
				{
					...
					this.obOneClickBtn = BX(this.visual.BUY_ONE_CLICK);
				}
			...
			if (this.errorCode === 0)
			{
				...
				this.obOneClickBtn && BX.bind(this.obOneClickBtn, 'click', BX.proxy(this.buyOneClick, this));
			...
			if (this.errorCode === 0)
			{
				...
				if (this.obQuantityLimit.all)
				{
					...
					else
					{
						...
						let limit_icon = '<span class="element_quant_limit"><svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
							...
							'</svg></span>';
						BX.adjust(this.obQuantityLimit.value, {html: limit_icon+strLimit});
		...
		buyOneClick: function()
		{
			switch (this.productType)
			{
				case 1: // product
				case 2: // set
					this.selected_id = this.product.id.toString();
					break;
				case 3: // sku
					this.selected_id = this.offers[this.offerNum].ID;
					break;
			}
			//console.log(this);
			//console.log(this.selected_id);
			this.buildModal('one_click_'+this.selected_id, 'one_click_'+this.selected_id)
		},

		buildModal: function(id, content)
		{
