    ...
    <div class="catalog_element" itemscope itemtype="http://schema.org/Product" id="<?= $itemIds['ID'] ?>">
        ...
        <section class="item">
            ...
            <div class="description">
                ...
                <div class="description__wrapper option-selector">
                                                                        ...
                                                                        if ($skuProperty['SHOW_MODE'] === 'PICT') {
                                                                            ...
                                                                            <li class="product-item-scu-item-color-container"
                                                                                ...
                                                                                <div class="product-item-scu-item-color-block">
                                                                                    <div class="product-item-scu-item-color img-postcard"
                                                                                         title="<?= $value['NAME'] ?>"
                                                                                ...
                                                                                <div class="option-selector-item__radio-row">
                                                                                    <div class="option-selector-item__radio-row__text">
                                                                                       <?= $value['NAME'] ?>
                                                                                    </div>
                                                                                    <div class="radio-button">
                                                                                        <div class="radio-button__container"></div>
                                                                            ...
                                                                            ?>
                                                                            <!--                                                                        <li class="product-item-scu-item-text-container option-selector" title="--><?//=$value['NAME']
                                                                            ?><!--"-->
                                                                            <!--                                                                            data-treevalue="--><?//=$propertyId
                                                                            ?><!--_--><?//=$value['ID']
                                                                            ?><!--"-->
                                                                            <!--                                                                            data-onevalue="--><?//=$value['ID']
                                                                            ?><!--">-->
                                                                            ...
                                                                            <!--                                                                                    <div class="option-selector-item__image-border option-selector-item__image-border--active">-->
                                                                            <!--                                                                                        <img class="option-selector-item__image"-->
                                                                            <!--                                                                                             src="/img/product-page/page-size/img_s.png"-->
                                                                            <!--                                                                                             alt="image"></div>-->
                                                                            <!--                                                                                    <div class="option-selector-item__radio-row">-->
                                                                            <!--                                                                                        <div class="option-selector-item__radio-row__text">-->
                                                                            <!--                                                                                            Размер --><?//=$value['NAME']
                                                                            ...
                                                                            <!--                                                                                        <div class="radio-button">-->
                                                                            <!--                                                                                            <div class="radio-button__container"></div>-->
                                                                            <!--                                                                                            <span class="radio-button__checkmark radio-button__checkmark--active"></span>-->
                                                                            <!--                                                                                        </div>-->
                                                                            <!--                                                                                    </div>-->
                                                                            <!--                                                                                    <div class="option-selector-item__price"><span-->
                                                                            <!--                                                                                                class="option-selector-item__price__value">3 490</span><span-->
                                                                            <!--                                                                                                class="option-selector-item__price__valuta">₽</span>-->
                                                                            <!--                                                                                    </div>-->
                                                                            <!--                                                                                </div>-->
                                                                            <!--                                                         </div>-->
                                                                            <!--                                                                        </li>-->
                                                                            ...
                                                                            <li class=" option-selector"
                                                                                ...
                                                                                <div class="option-selector__item">
                                                                                    <div class="option-selector-item">
                                                                                        <div class="option-selector-item__image-border option-selector-item__image-border--active">
                                                                                            <div class="option-selector-item__image"
                                                                                                 style="background-image: url('<?= CFile::GetPath($arItem['PROPERTIES']['IMG']['VALUE']); ?>')">
                                                                                            </div>
                                                                                            <div class="option-selector-item__image"
                                                                                                 style="background-image: url('<?= CFile::GetPath($arItem['IMG']); ?>')">
                                                                                            </div>
                                                                                            <div class="option-selector-item__image"
                                                                                                 style="background-image: url('<?= $value['PICT']['SRC'] ?>')">
                                                                                            </div>
            ...
            <div class="right__section">
                <div class="right__section__brand">
                    ...
                    if ($arResult['DISPLAY_PROPERTIES'][$arParams['BRAND_PROP_CODE'][0]]) {
                        ?>
                        <p><?= $arResult['DISPLAY_PROPERTIES'][$arParams['BRAND_PROP_CODE'][0]]['NAME']; ?>:
                            <span><?= $arResult['DISPLAY_PROPERTIES'][$arParams['BRAND_PROP_CODE'][0]]['DISPLAY_VALUE']; ?></span>
                        </p>

                        <a href="#">Все
                            товары <?= $arResult['DISPLAY_PROPERTIES'][$arParams['BRAND_PROP_CODE'][0]]['DISPLAY_VALUE']; ?></a>
                        <?
                    }
                    ?>
                    <?
                    if ($arResult['SHOW_OFFERS_PROPS']) {
                        ...
                        ?>
                        <p class="catalog_element_artnumber"><?= $arResult['PROPERTIES']['ARTNUMBER']['NAME']; ?>:
                            <span><?= $arResult['PROPERTIES']['ARTNUMBER']['VALUE']; ?></span></p>
                        <?
                    }
                    ?>
                </div>
                    ...
                    if ($arParams['SHOW_MAX_QUANTITY'] !== 'N') {
                        if ($haveOffers) {
                            ...
                            if (
                                ...
                                <div class="product-item-detail-info-container" id="<?= $itemIds['QUANTITY_LIMIT'] ?>">
                                    <div class="product-item-detail-info-container-title">
                                    <span class="element_quant_limit"><svg width="16" height="12" viewBox="0 0 16 12"
                                                                           fill="none"
...
<path d="M14.994 1.53938L13.7225 0.262794C13.5481 0.08762 13.3361 0 13.0869 0C12.8374 0 12.6253 0.08762 12.451 0.262794L6.31744 6.42996L3.56859 3.66081C3.39404 3.48557 3.18213 3.39805 2.93288 3.39805C2.68347 3.39805 2.47156 3.48557 2.29701 3.66081L1.02546 4.93743C0.850913 5.11264 0.763672 5.32546 0.763672 5.57582C0.763672 5.82599 0.850913 6.03901 1.02546 6.21418L4.41002 9.6121L5.68167 10.8887C5.85612 11.064 6.0681 11.1515 6.31744 11.1515C6.56669 11.1515 6.77867 11.0638 6.95321 10.8887L8.22483 9.6121L14.994 2.81607C15.1684 2.64083 15.2558 2.42805 15.2558 2.17768C15.256 1.92744 15.1684 1.71462 14.994 1.53938Z"></path>
                                ...
                                <div class="product-item-detail-info-container" id="<?= $itemIds['QUANTITY_LIMIT'] ?>">
                                    <div class="product-item-detail-info-container-title">
                        <span class="element_quant_limit"><svg width="16" height="12" viewBox="0 0 16 12" fill="none"
                                                               xmlns="http://www.w3.org/2000/svg">
<path d="M14.994 1.53938L13.7225 0.262794C13.5481 0.08762 13.3361 0 13.0869 0C12.8374 0 12.6253 0.08762 12.451 0.262794L6.31744 6.42996L3.56859 3.66081C3.39404 3.48557 3.18213 3.39805 2.93288 3.39805C2.68347 3.39805 2.47156 3.48557 2.29701 3.66081L1.02546 4.93743C0.850913 5.11264 0.763672 5.32546 0.763672 5.57582C0.763672 5.82599 0.850913 6.03901 1.02546 6.21418L4.41002 9.6121L5.68167 10.8887C5.85612 11.064 6.0681 11.1515 6.31744 11.1515C6.56669 11.1515 6.77867 11.0638 6.95321 10.8887L8.22483 9.6121L14.994 2.81607C15.1684 2.64083 15.2558 2.42805 15.2558 2.17768C15.256 1.92744 15.1684 1.71462 14.994 1.53938Z"></path>
</svg></span>
                                        <?= $arParams['MESS_SHOW_MAX_QUANTITY'] ?>:
