...
<div class="catalog_item_block">
    <div class="catalog_marker">
        ...
        if (!empty($item['LABEL_ARRAY_VALUE'])) {
            foreach ($item['LABEL_ARRAY_VALUE'] as $code => $value) {
                ?>
                <div class="marker_hit"<?= (!isset($item['LABEL_PROP_MOBILE'][$code]) ? ' class="hidden-xs"' : '') ?>>
                    <div>
                        <?= $value ?>
                    </div>
                </div>
    ...
    <div class="catalog_action">
        ...
        if (
            ...
            ?>
            <div class="add_to_compare" id="<?= $itemIds['COMPARE_LINK'] ?>">
    ...
    <div class="catalog_quick_view"><a class="btn_white"
                                       id="<?= $itemIds['QUICK_SHOW'] ?>"><?= Loc::getMessage("PK_CATALOG_FAST_VIEW") ?></a>
    </div>
    <a href="<?= $item['DETAIL_PAGE_URL'] ?>" title="<?= $imgTitle ?>" class="catalog_item_img"
       id="<?= $itemIds['PICT'] ?>" style="background-image: url('<?= $item['PREVIEW_PICTURE_SECOND']['SRC']; ?>')">
        <!--        <img src="--><? //=$item['PREVIEW_PICTURE_SECOND']['SRC'];?><!--">-->
    </a>
    <a href="<?= $item['DETAIL_PAGE_URL'] ?>" title="<?= $imgTitle ?>"
       class="catalog_item_title"><?= $productTitle ?></a>
    <div class="catalog_instock_art">
        <?= Profitkit\Shopstart\Shop::getProductAvailable($item)['html']; ?>
        <span>Артикул: <?= $item['PROPERTIES']['ARTICLE']['VALUE']; ?></span>
    </div>
    ...
    <div class="catalog_item_hover">
            ...
            if ($actualItem['CAN_BUY']) {
                if ($arParams['ADD_TO_BASKET_ACTION'] === 'BUY') { ?>
                    <div class="product-item-button-container" id="<?= $itemIds['BASKET_ACTIONS'] ?>">
                        <a class="btn" data-toggle="pkModal" data-target="#callbackModal"
                           data-ajax="/ajax/form.php?form_id=34&field=SERVICE&value=<?= $item['NAME']; ?>"
        ...
        <a class="btn_white" data-toggle="pkModal" data-target="#callbackModal"
           data-ajax="/ajax/form.php?form_id=<?= $arParams['ONECLICK_FORM_ID']; ?>&field=PRODUCT&value=<?= $item['NAME']; ?>"
           id="<?= $itemIds['BUY_ONE_CLICK'] ?>">Купить в 1 клик</a>
        <!--        <ul>-->
