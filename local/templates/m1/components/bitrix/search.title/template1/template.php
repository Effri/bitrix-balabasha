...
if($arParams["SHOW_INPUT"] !== "N"):?>
	...
	<form action="<?echo $arResult["FORM_ACTION"]?>">
        <input id="<?echo $INPUT_ID?>" type="text" name="q" value="" size="40" maxlength="50" autocomplete="off" class="header_search_input" placeholder="Поиск"/><button name="s" type="submit" class="header_search_btn"><i><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
