...
<!--            </div>-->
            <div class="col-12 footer_social">
                <a href="/" class="col-4"><? $APPLICATION->IncludeFile(SITE_DIR."include/logo.php",Array(),Array("MODE"=>"text"));?></a>
...
<!--                <b>--><?//=GetMessage('PK_SOCIAL');?><!--</b>-->
	...
	".default", 
	array(
		"VK" => "https://vk.com/balabasha_flowers",
		"FB" => "",
		"INST" => "https://www.instagram.com/balabasha_flowers/",
		"TW" => "",
		"GOOGLE" => "",
