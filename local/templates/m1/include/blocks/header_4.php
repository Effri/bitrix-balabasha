...
<div class="header_info">
 ...
 <? */ ?>
        ...
        <div class="header_city">
            ...
            <span><?=GetMessage('PK_YOU_CITY');?></span> <a data-toggle="pkModal" data-target="#changecityModal" data-ajax="/ajax/changeCity.php">Санкт-Петербург<i><svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
