// var li_block = document.getElementsByClassName('product-item-scu-item-color-container');
// var par = document.getElementsByClassName('radio-button__checkmark');
// li_block.onclick = function() {
//     par.classList.add("radio-button__checkmark--active");
// }
// li_block.onclick = function() {
//     par.classList.remove("radio-button__checkmark--active");
// }
//
// var btns = document.getElementsByClassName('intro__btn');
// var par = document.getElementsByClassName('PID_327');
// var par2 = document.getElementsByClassName('PID_328');
// btns[0].onclick = function() {
//     par[0].classList.add("main--main-bg");
//     par2[0].classList.add("main--main-bg_2");
// }
// btns[1].onclick = function() {
//     par[0].classList.remove("main--main-bg");
//     par2[0].classList.remove("main--main-bg_2");
// }
...
document.getElementsByClassName("PID_NAME").placeholder = "Ваше имя";
...
jQuery(document).ready(function () {
    ...
    jQuery(".first").click(function(){
        // jQuery(".button-selector__item").addClass("button-selector__item--active");
        // jQuery(this).find(".second").remove("button-selector__item--active");
        jQuery(".second").removeClass("button-selector__item--active");
        jQuery(this).addClass("button-selector__item--active");
        jQuery(".PID_327").addClass("active");
        jQuery(".PID_328").addClass("active");
        jQuery(".build-bouquet-form__button-wrapper").addClass("top-up");
    });
    jQuery(".second").click(function(){
        jQuery(".first").removeClass("button-selector__item--active");
        jQuery(this).addClass("button-selector__item--active");
        // jQuery(".button-selector__item").addClass("button-selector__item--active");
        // jQuery(this).find(".first").remove("button-selector__item--active");

        jQuery(".PID_327").removeClass("active");
        jQuery(".PID_328").removeClass("active");
        jQuery(".build-bouquet-form__button-wrapper").removeClass("top-up");
    });

    jQuery('.PID_337').attr('type', 'number');
    jQuery('.PID_337').attr('min', '1500');

    // jQuery(".selected").click(function(){
    //    // jQuery(".product-item-scu-item-color-container").removeClass("radio-button__checkmark--active");
    //    //  jQuery(".radio-button__checkmark").removeClass("radio-button__checkmark--active");
    //     jQuery(".radio-button__checkmark").toggleClass("radio-button__checkmark--active");
    // });
